...
Keling, yangi elementni Doubly Linked List oxiriga qo'shish uchun mehtod yaratamiz. Yuqoridagidek biz methodni o'zini yozib ketamiz, siz ularni o'z klassingiz ichiga qo'shib tahlil qilishingiz mumkin:
...
# Bu method tailni (ya'ni oxirgi elementni) qaytarish uchun.
# Biror qiymatni qidirish uchun ishlatiladi agar bo'lsa True bo'lmasa False qaytaradi.
def search(self, value: any) -> bool:
